...
public class JIBuatDiary extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            String sql = "select No from diary;";
            Statement state = c.createStatement();
            ResultSet result = state.executeQuery(sql);
            int no = 1;
            
            //eksekusi database
            final PreparedStatement prepare = c.prepareStatement("insert into diary(no, tanggal, judul, isi) value(?, ?, ?, ?);");
            ...
            JOptionPane.showMessageDialog(null, "Pengisian Tanggal kurang tepat atau Isi, dan Judul Diary tidak boleh kosong !");
        }

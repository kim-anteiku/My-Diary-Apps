...
public class JHapusDiary extends javax.swing.JInternalFrame {
    ...
    public void loadData(){
        ...
        try{
            ...
            String sql = "select no, judul, tanggal from diary;";
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(35, 35, 35)
                        .addComponent(TombolBatal, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void TombolHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TombolHapusActionPerformed
        ...
        if(konfirmasi==0){
            try{
            String sql = "delete from diary where no = ?; ";
            Connection c = Koneksi.getKoneksi();
